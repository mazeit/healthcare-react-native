...
import { StyleSheet, Text, View, TextInput, Image, TouchableOpacity, ImageBackground, KeyboardAvoidingView, TouchableWithoutFeedback, Keyboard } from 'react-native';
...
class SignInEmail extends React.Component {
    ...
    verifyUser() {
        this.setState({ loader: true });
        this.props.verifyEmail(this.state.activUserEmail).then(res=>{
                    ...
                    this.state.loader ?
                        <View style={{ flex: 1, backgroundColor: '#454545', opacity: 0.8 }}><LoaderWait /></View> :
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                {/*<KeyboardAvoidingView style={styles.email} behavior="padding" enabled>*/}
