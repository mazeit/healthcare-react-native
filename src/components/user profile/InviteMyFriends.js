                    ...
                    <View style={styles.inviteFriendContainer}>
                        ...
                        <View style={styles.inviteFriendContent}>
                            ...
                            <View style={{ flex: 2, alignItems: 'flex-start', marginTop: 10, marginBottom: 10 }}>
                                <Text style={{ fontFamily: 'DINPro', fontSize: 16, color: '#838383', }}>You have already successfully invited {this.state.invitedFriends} friends. {3 - this.state.invitedFriends} more and you get one challenge for free.</Text>
                            </View>
