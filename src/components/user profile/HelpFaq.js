                ...
                <View style={styles.container}>
                    ...
                    <ScrollView style={styles.helpFaqContainer}>
                        ...
                        <View style={[styles.termsOfUseBlock, { marginTop: 0 }]}>
                            ...
                            <Text style={{ fontFamily: 'DINPro-Light', fontSize: 18, color: '#838383', margin: 20, textAlign: 'center' }}>Do you have issues with your app or your challenge? These answers here might help you:</Text>
                        ...
                        <View style={[styles.termsOfUseBlock, { flexDirection: 'column', height: 309 }]}>
                            ...
                            <Text style={{ flex: 1, height: 66, fontFamily: 'DINPro-Light', fontSize: 18, color: '#838383', margin: 20, marginBottom: 0, textAlign: 'center' }}>No answer to your question? Be free to contact our support team for a personal assistence. You can reach us:</Text>
                            ...
                            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', flexDirection: 'column', }}>
                                <Text style={{ flex: 1, fontFamily: 'DINPro-Light', fontSize: 16, color: '#4AB3E2', textAlign: 'center' }}>{this.state.conntactInfo.day}</Text>

                                <Text style={{ flex: 1, fontFamily: 'DINPro-Light', fontSize: 16, color: '#4AB3E2', textAlign: 'center' }}>{this.state.conntactInfo.time}</Text>

                                <Text style={{ flex: 1, fontFamily: 'DINPro-Light', fontSize: 16, color: '#4AB3E2', textAlign: 'center' }}>{this.state.conntactInfo.phone}</Text>

                                <Text style={{ flex: 1, fontFamily: 'DINPro-Light', fontSize: 16, color: '#4AB3E2', marginBottom: 20, textAlign: 'center' }}>{this.state.conntactInfo.email}</Text>
                            </View>
