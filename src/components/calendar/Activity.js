                ...
                <View style={{ flex: 9, }}>
                    ...
                    <View style={{ flex: 7, alignItems: 'center', justifyContent: 'center', }}>
                        ...
                        <View style={[styles.descriptionContainer, { flex: 3.5, marginTop: -50 }]}>
                            ...
                            <Text style={{ textAlign: 'center', fontFamily: 'DINPro-Light', fontSize: 16, color: '#838383', padding: 5, paddingLeft: 10, paddingRight: 10 }}>{this.state.activityData.description}</Text>
                        </View>
