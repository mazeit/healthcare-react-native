...
export default class MyChallenge extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        };
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', marginBottom: 20}}>
                                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                                    <ProgressCircle
                                        ...
                                        color="#AE0069"
                                    >
                                        <Text style={{ fontSize: 18, color: '#AE0069' }}>45%</Text>
                                    </ProgressCircle>
                                ...
                                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                                    <ProgressCircle
                                        ...
                                        color="#D4B870"
                                    >
                                        <Text style={{ fontSize: 18, color: '#D4B870' }}>45%</Text>
                                    </ProgressCircle>
                                ...
                                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                                    <ProgressCircle
                                        ...
                                        color="#8ACE91"
                                    >
                                        <Text style={{ fontSize: 18, color: '#8ACE91' }}>45%</Text>
                                    </ProgressCircle>
