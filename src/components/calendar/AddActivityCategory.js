        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F5F5F5', width: width, }}>
                    ...
                    <TouchableOpacity style={styles.categoryContainer} onPress={() => this.props.goToNext()}>
                    ...
                    <TouchableOpacity style={[styles.categoryContainer, { marginBottom: 10 }]} onPress={() => this.props.goToNext()}>
