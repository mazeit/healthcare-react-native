                ...
                <View style={styles.container}>
                    ...
                    <ScrollView>
                        <View  style={styles.intro}> 
                            ...
                            <Text style={{ height: 26, fontFamily: 'DINPro', fontSize: 22, color: '#454545', marginTop: 20, alignItems: 'center', textAlign: 'center'}}>Es freut uns sehr, dass Livinflow Dein Interesse wecken konnten! </Text>
