                        ...
                        <View style={styles.content}>
                            ...
                            <View style={[styles.contentSubBlock, { marginTop: -50, }]}>
                                <View style={[styles.details, { margin: 10 }]}>
                                    <Text style={{ fontFamily: 'DINPro-Light', fontSize: 22, color: '#454545', textAlign: 'center' }}>Kathryn Budig</Text>
                                </View>
                            ...
                            <View style={styles.contentSubBlock}>
                                <View style={[styles.details, { margin: 10 }]}>
                                    <View style={{ flex: 1, alignItems: 'flex-start', margin: 20, marginBottom: 0 }}>
                                        <Text style={{ fontFamily: 'DINPro-Light', fontSize: 16, color: '#838383', }}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores.</Text>
                                    </View>
                                    <View style={{ flex: 1, alignItems: 'flex-start', margin: 20, marginBottom: 0 }}>
                                        <Text style={{ fontFamily: 'DINPro-Light', fontSize: 16, color: '#838383', }}>Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore.</Text>
                                    </View>
                                </View>
                            </View>
