                            ...
                            <View style={styles.content}>
                                ...
                                <View style={[styles.contentSubBlock, { marginTop: -50, }]}>
                                    ...
                                    <View style={[styles.details, { margin: 10, marginTop: 0 }]}>
                                        <Text style={{ textAlign: 'center', fontFamily: 'DINPro-Light', fontSize: 16, color: '#838383', padding: 5, paddingLeft: 10, paddingRight: 10 }}>Build a strong home practice with these sequences, tutorials, challenge poses, tips, and advice for yogis of every level. </Text>
                                    </View>
                                ...
                                <View style={styles.contentSubBlock}>
                                    <View style={[styles.details, { margin: 10 }]}>
                                        <Text style={{ fontFamily: 'DINPro-Light', fontSize: 22, color: '#454545', marginBottom: 10 }}>Asanas</Text>
                                        {
                                            menuList.map((item, i) =>
                                                <View key={i} style={styles.informationContainer}>
                                                    <View style={{ flex: 1, alignItems: 'flex-start' }}>
                                                        ...
                                                        <Text style={{ fontFamily: 'DINPro-Light', fontSize: 16, color: '#838383' }}>{item.subHead}</Text>
                                                    </View>
                                                    <View style={{ alignItems: 'flex-end', flexDirection: 'row', justifyContent: 'center', width: 100 }}>
                                                        <Icon name='time' size={50} color={'#454545'} />
                                                        <Text style={{ fontFamily: 'DINPro-Light', fontSize: 16, color: '#838383', marginBottom: 15 }}>2 min</Text>
                                                    </View>
                                                </View>
                                            )
                                        }
