    ...
    return (
        <View style={[styles.container, { backgroundColor: this.state.backgroundColor, }]}>
            ...
            <View style={styles.buttons}>
                <TouchableHighlight style={{ backgroundColor: this.state.backgroundColor , flex: 1, width: '100%', marginTop: '5%', alignItems: 'center', justifyContent: 'center', borderColor: '#ffffff', borderRadius: 50, borderWidth: 0.5}}>
                    <Text style={{ marginLeft: '20%', marginRight: '20%', fontFamily: 'DINPro', fontSize: 17, color: '#ffffff'}}>More Details</Text>
                </TouchableHighlight>
                <TouchableHighlight style={{ backgroundColor: '#FFFFFF', flex: 1, width: '100%', marginTop: '5%', alignItems: 'center', justifyContent: 'center', borderRadius: 50}}>
